...
The Parse Server  deployment package contains a sequence software (referred to as "components") required for Parse Server  to run. The important information such as the component name, installation directory path, configuration file path, port, version, etc. are listed below.

## Path

### Parse Server 

Parse Server  installation directory: */data/wwwroot/metabase*  
Parse Server  configuration file: */data/wwwroot/metabase/metabase.conf*  
